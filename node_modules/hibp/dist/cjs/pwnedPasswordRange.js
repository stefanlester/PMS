...
var fetchFromApi = require('./api/pwnedpasswords/fetchFromApi.js');
...
function pwnedPasswordRange(prefix) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return fetchFromApi.fetchFromApi("/range/".concat(encodeURIComponent(prefix)), options) // create array from lines of text in response body
  .then(function (data) {
    return data.split('\n');
