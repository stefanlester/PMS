...
var fetchFromApi = require('./api/haveibeenpwned/fetchFromApi.js');
...
function breach(breachName) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return fetchFromApi.fetchFromApi("/breach/".concat(encodeURIComponent(breachName)), options);
}
